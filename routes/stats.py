...
routes/stats.py
================
GET /api/stats — returns total verified amount and donor count.
"""
...
def get_stats():
    ...
    try:
        ...
        results = list(current_app.db.donations.aggregate(pipeline))
        ...
        return jsonify({"total_raised": total_raised, "donor_count": donor_count}), 200
